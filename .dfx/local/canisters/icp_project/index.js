...
import { idlFactory } from './icp_project.did.js';
export { idlFactory } from './icp_project.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICP_PROJECT;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_project.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_project canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_project.did.js")._SERVICE>}
 */
export const icp_project = createActor(canisterId);
